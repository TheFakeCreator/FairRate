...
import { LayoutDashboard, Sliders, Settings, Star, Search, Plus, Trash2, Save, Film, RefreshCw } from 'lucide-react'
import { getAllRatings, getPresets, savePresets, pullFromCloud, pushToCloud } from '../lib/storage'
...
function OptionsPage() {
  ...
  useEffect(() => {
    async function loadData() {
      setLoading(true)
      const [rData, pData, userData] = await Promise.all([
        getAllRatings(),
        getPresets(),
        getUser()
      ])
