    ...
    <>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-8 pb-24 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <a 
            href="https://github.com/TheFakeCreator/FairRate/releases/latest/download/FairRate-v1.3.1.zip"
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-20 border-t border-white/10">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black leading-tight">Your Ratings, Visualized.</h2>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-24 border-t border-white/10">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-6">Seamless IMDb Integration.</h2>
          <p className="text-lg md:text-xl text-gray-400">FairRate lives directly inside your IMDb pages. It replaces the native 1-10 star clicker but still syncs your final score to your official account in the background.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          <div className="bg-[#111] rounded-3xl p-6 md:p-8 border border-white/5 hover:border-imdb-yellow/20 transition-colors group">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3">Native Injection</h3>
            <p className="text-gray-400 text-sm md:text-base">The new "Rate" button is injected perfectly into the IMDb UI so it feels completely natural and non-intrusive.</p>
          </div>
          <div className="bg-[#111] rounded-3xl p-6 md:p-8 border border-white/5 hover:border-imdb-yellow/20 transition-colors group">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3">Contextual Modal</h3>
            <p className="text-gray-400 text-sm md:text-base">A beautiful, distraction-free modal that forces you to think critically about 5 distinct aspects of the film.</p>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-24 border-t border-white/10">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="order-2 md:order-1 relative">
            ...
            <img src={`${import.meta.env.BASE_URL}images/custompresets.png`} alt="Custom Presets" className="absolute -bottom-4 -right-2 md:-bottom-12 md:-right-8 w-[75%] md:w-2/3 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] border border-white/10 z-20 hover:-translate-y-4 transition-transform duration-500" />
          </div>
          <div className="order-1 md:order-2 space-y-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black leading-tight">Your Personal Movie Vault.</h2>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-base md:text-lg text-gray-300">
                <Star className="w-5 h-5 text-imdb-yellow shrink-0" /> Custom genre weighting multipliers
              </li>
              <li className="flex items-center gap-3 text-base md:text-lg text-gray-300">
                <Star className="w-5 h-5 text-imdb-yellow shrink-0" /> Secure Cloud Sync via Google Auth
              </li>
              <li className="flex items-center gap-3 text-base md:text-lg text-gray-300">
