    ...
    <div className="max-w-4xl mx-auto px-6 py-20">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-400">
          Since FairRate is not yet on the Chrome Web Store, you'll need to load
          it manually. It only takes 30 seconds!
        </p>
      </div>
      ...
      <div className="mt-20 p-8 rounded-2xl bg-imdb-yellow/10 border border-imdb-yellow/20 text-center">
        <h3 className="text-2xl font-bold text-imdb-yellow mb-4">
          You're all set! 🎉
        </h3>
        <p className="text-gray-300">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-white font-bold underline underline-offset-4 hover:text-imdb-yellow transition-colors"
          >
            IMDb
          </a>{" "}
          and check out any movie page to see FairRate in action!
        </p>
      </div>
    </div>
  );
